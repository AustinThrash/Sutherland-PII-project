...
In order to sort my data and find the top 5 for each studio type in the past 5 years, I am going to research multiple credible gaming news channels and look for their polls on the people's most popular game. This can be done by looking up surveys that game launching sites have given their users (like the Game of The year Awards). After I get the number of titles I need I will view how many current downloads the game has accrued for each title, how much money/profit the game made for the studio, current players to this day, and overall sentiment for the game.
